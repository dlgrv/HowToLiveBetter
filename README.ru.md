...
<img src="og-ru.png?v=20260922" alt="Гид по жизни с лучшим соотношением цены и результата — меньше времени, сил и расходов, больше жизни, свободы и денег" width="820">
...
- 🇬🇧 [English](README.md) → [читать на сайте](https://dlgrv.github.io/HowToLiveBetter/en/)
- 🇨🇳 [中文](README.zh.md) → [читать на сайте](https://dlgrv.github.io/HowToLiveBetter/zh/)
