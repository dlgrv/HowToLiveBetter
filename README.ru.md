...
Из всех 603 пунктов книги: очень высокое соотношение у 104 пунктов (17%), высокое — у 184 (31%), обычное — у 315 (52%). Утолщение среднего уровня сделано намеренно: в основе лежит лишь трёхуровневая оценка порядка результата, а более мелкое деление было бы притворной точностью.
